...
if (isset($_POST['add_table'])) {
    ...
    $sql = "INSERT INTO tables (table_number, capacity, location, status) VALUES ('$table_number', '$capacity', '$location', '$status')";
...
if (isset($_POST['edit_table'])) {
    ...
    $location = mysqli_real_escape_string($con, $_POST['location']);
    $status = mysqli_real_escape_string($con, $_POST['status']);
    $sql = "UPDATE tables SET table_number='$table_number', capacity='$capacity', location='$location', status='$status' WHERE id=$id";
    mysqli_query($con, $sql);
    header('Location: manage_tables.php');
    exit();
}
    ...
    <div class="admin-container">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item">
                    <a href="manage_tables.php" class="nav-link active">
        ...
        <div class="main-content">
            ...
            <div class="page-header">
                <h1><i class="fas fa-table me-3"></i>Manage Tables</h1>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="post" style="display:inline-block;">
                                        ...
                                        <input type="text" name="table_number" value="<?= htmlspecialchars($row['table_number']) ?>" required class="form-control mb-2">
                                        <input type="number" name="capacity" value="<?= htmlspecialchars($row['capacity']) ?>" required class="form-control mb-2">
                                        <input type="text" name="location" value="<?= htmlspecialchars($row['location']) ?>" required class="form-control mb-2">
                                ...
                                <td>
                                    <button type="submit" name="edit_table" class="btn btn-sm btn-primary mb-2">Save</button>
                                    </form>
                                    <a href="manage_tables.php?delete=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this table?')">Delete</a>
                                </td>
                            </tr>
                            <?php endwhile; ?>
                        </tbody>
            ...
            <div class="form-section">
                <h3><i class="fas fa-plus-circle me-2"></i>Add New Table</h3>
                <form method="post">
                    <div class="row mb-3">
                        <div class="col-md-3">
